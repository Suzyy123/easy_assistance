...
import 'package:easy_assistance_app/Todo_task/Meeting_All/MeetingPage.dart';
import 'package:easy_assistance_app/Todo_task/Notes_All/All_Notes.dart';
import 'package:easy_assistance_app/Todo_task/Tasks_All/TaskListPage.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import '../ChatPage/FriendRequestPage.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => TaskListPage()), // Replace with your target page
                      );
              },
                              child: Container(
                                width: 340,
                        ...
                        GestureDetector(
                            onTap: () {
                              // Navigate to the desired page when the Ongoing Task container is tapped
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => MeetingsPage()), // Replace with your target page
                              );
                            },
                              child: Container(
                                width: 340,
                          ...
                          GestureDetector(
                              onTap: () {
                                // Navigate to the desired page when the Completed Task container is tapped
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => NotesPage()), // Replace with your target page
                                );
                              },
                              child: Container(
                                width: 340,
